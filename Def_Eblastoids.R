...
if (file.exists(savefile)) {
  ...
  data.list[[n]] <- RenameIdents(data.temp, '0' = 'EB_TLC','1'='EB_UI13','2'="EB_TLC",'3'='EB_U5','4'='EB_UI13','5'="EB_ELC",'6'="EB_ELC",'7'="EB_U6",'8'='EB_TLC','9'="EB_U10",'10'="EB_HLC")
  ...
  data.ob <- RenameIdents(data.it, '0' = 'EB_TLC','1'='EB_UI13','2'="EB_ELC",'3'='EB_UI13','4'='EB_TLC','5'="EB_U5",'6'="EB_U6",'7'="EB_ELC",'8'='EB_TLC','9'="EB_TLC",'10'="EB_U10",'11'="EB_HLC",'12'='EB_UN34','13'='EB_UN34')
...
for (n in c("EB_UN34","EB_UI13","EB_UE7","EB_ELC","EB_HLC", "EB_TLC0","EB_TLC4","EB_TLC8","EB_TLC9","EB_U10","EB_U5","EB_U6")) {
...
temp.cell <- list()
for (n in c("EB_UI13","EB_ELC","EB_HLC", "EB_TLC0","EB_TLC8","EB_U10","EB_U5","EB_U6")) {
...
EBD2.LW60.meta.ds <- do.call("bind_rows",lapply(temp.cell[c("EB_ELC","EB_HLC")],function(x){return(FunMaSF(x,150))})) %>% bind_rows(
  do.call("bind_rows",lapply(temp.cell[c("EB_UI13","EB_U10","EB_U5","EB_U6")],function(x){return(FunMaSF(x,100))}))
